(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.exportas = factory());
  ...
  ***************************************************************************** */
  ...
  var wordexport = function wordexport(wrap, config) {
    ...
    mhtmlBottom += "--NEXT.ITEM-BOUNDARY--";
    var styles = "";
    var fileContent = static_word.mhtml.top.replace("_html_", static_word.mhtml.head.replace("_styles_", styles) + static_word.mhtml.head.replace("_headerAlign_", config.headerAlign) + static_word.mhtml.head.replace("_footerAlign_", config.footerAlign) + static_word.mhtml.body.replace("_body_", wrap.innerHTML)) + mhtmlBottom;
    var fileSuffix = config.suffix ? config.suffix == "doc" ? "application/msword;charset=utf-8" : config.suffix == "docx" ? "application/vnd.openxmlformats-officedocument.wordprocessingml.document" : "application/msword;charset=utf-8" : "application/msword;charset=utf-8";
  ...
  var WordExports = /*#__PURE__*/function () {
    ...
    return _createClass(WordExports, [{
      key: "init",
      value: function () {
      ...
      value: function exportWord() {
        FileSaver_min(wordExport(this.c_dom, this.config), this.config.fileName + ".doc");
        this.config.success();
      }
    }, {
      key: "sheetToSelf",
  ...
  // 导出word
  var exportWord = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(domElem, config) {
      var wordExports;
      return regenerator.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            wordExports = new wordexport_1(domElem, config);
            _context.next = 3;
            return wordExports.init();
          case 3:
    ...
    return function exportWord(_x, _x2) {
